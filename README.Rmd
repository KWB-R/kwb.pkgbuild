[![Appveyor build Status](https://ci.appveyor.comapi/projects/status/github/KWB-R/kwb.lca?branch=master&svg=true)](https://ci.appveyor.com/project/KWB-R/kwb-lca/branch/master))
