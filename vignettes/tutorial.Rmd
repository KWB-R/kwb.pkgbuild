...
In the following, we present the commands required to setup and create your
new package. We suggest that you write the corresponding code into a `.R` script 
file. Once the package is created, we suggest to put the script file into the
`inst/extdata` folder of your package. This makes the creation of the package
reproducible and can be used as a template for the creation of further packages.
