...
on your local machine. For the steps described in the following, use this folder 
instead of `temp_pkg` so that your package template will be created direcly in 
