...
>Execution halted
```
In addition if you require **private and public** [see](#1.1.2-Private-and-Public-KWB-R-Packages) 
KWB-R packages from GitHub but only provide a `GITHUB_PAT` with access to 
**public** ([see](#1.1.1-Public-KWB-R-Packages)) KWB-R packages you might get a error 
